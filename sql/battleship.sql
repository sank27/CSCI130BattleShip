...
CREATE TABLE `attacks` (
  ...
  KEY `idxAttackGameId` (`game_id`),
  KEY `idxAttackPlayerId` (`player_id`),
  PRIMARY KEY (`id`)
...
CREATE TABLE `gamelog` (
  ...
  PRIMARY KEY (`id`),
  KEY `idxGLogGameId` (`game_id`),
  KEY `idxGLogPlayerId` (`player_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

/*Data for the table `gamelog` */
...
CREATE TABLE `players` (
  ...
  `player_id` int(20) DEFAULT NULL,
  `created` datetime DEFAULT current_timestamp(),
  KEY `idxPlayersGameId` (`game_id`),
  KEY `idxPlayersPlayerId` (`player_id`),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
